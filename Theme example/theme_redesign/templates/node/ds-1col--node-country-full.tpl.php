...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php print render($content['ssl']); ?>
    ...
    <a href="#centre-partners" class="center-partners-link">Centre partners</a>
  ...
  <?php if (!empty($content['field_country_area_manager'])): ?>
    <div class="area-manager" >
      <?php print render($content['field_country_area_manager']); ?>
    </div>
  <?php endif; ?>
